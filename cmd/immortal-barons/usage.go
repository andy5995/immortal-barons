...
var usageGroups = []struct {
	...
	{"Sysop / game admin", []string{"set-dropfile", "reset", "reset-from-config", "add-ai", "maint", "players"}},
	{"Inter-BBS", []string{"ibbs-reset", "board-id", "inbound", "outbound", "import-bbs-cfg", "planetary", "full", "scores", "detailed", "league-routes", "league-config", "export", "import"}},
