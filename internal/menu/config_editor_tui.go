...
const (
	...
	helpStdInvest          = "The investment return over 10 days when Steady Investment Rate is on: 35 is 3.5% a day, and the maximum (100) is 10% a day. When Steady Investment Rate is off, the return drifts each day with total investment and this value is not used."
