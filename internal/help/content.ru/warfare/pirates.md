...
Pirates raid players at random. A raid is not a battle — a faction that owns
...
the faction new regions, so a pirate that just robbed someone holds more land.
...
tanks. One raid often recovers what a faction took from you; two or three will
if it is fat.  Attacking costs you casualties whether you win or lose, so do
not raid a faction that holds nothing.
...
Tip: a faction you keep beaten stays harmless, because its army is only what it
