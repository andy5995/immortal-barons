...
координатора, пунктом Изменить дипломатию.

## Что он делает и чего не делает

Список — это записка вашего координатора баронам собственной доски. Он
говорит, что ваша доска думает о планете. В игре он почти ничего не меняет:
...
- **Торговля.** Покупать на рынке другой планеты вы можете, только пока ваша
  ...
  должна пометить их как Allied, чтобы заявка ушла, а их — пометить вас как
  Allied, чтобы её выполнить. Если союз распался, пока заявка в пути, золото
  вернётся к вам.
