...
Координатор может публиковать директивы для всей станции: меню «Сообщения»,
пункт «Директивы координатора». Они показываются каждый раз, когда вы
выбираете «Играть», и их можно перечитать через тот же пункт меню. Там же
координатор их пишет, дополняет или стирает.
