...
Торговля в меню Межпланетные операции, затем Рынки и выберите планету.

В списке только планеты, которые ваш координатор пометил как Allied.
...
Ваш сисоп может отключить эту возможность для всей лиги — тогда пункта
Торговля в меню Межпланетные операции не будет.
