...
строка на угрозу, ближайшая сверху, и отсчёт идёт прямо у вас на глазах —
`3h`, потом `90m`, потом `away`, когда отряд ушёл. Уже летящее оружие показано
с числом дней до падения.

Пустой список не доказывает, что к вам никто не идёт. Кроме уже летящего
оружия, донести о чём-либо может только наблюдатель, размещённый на другой
планете.
...
Если отправить ещё одного SpyGuy на планету, за которой отсюда уже следят,
сроки не складываются. Срок становится равен большему из двух, а платите вы
всё равно за каждый купленный день. Это касается всех баронов вашей планеты,
потому что наблюдатель у них общий. Отправляйте нового, когда срок старого
истечёт.
