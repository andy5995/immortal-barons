...
- `m` добавляет шесть нулей. Нажмите `2`, затем `m` — и вы увидите
  `2000000`.
- `b` добавляет девять нулей. Нажмите `3`, затем `b`, и вы увидите
  `3000000000`.

Если ввести число больше максимума, игра при нажатии Enter заменит его на
максимум. Нажмите Enter ещё раз, чтобы его принять.
