...
so the extra weight a Quick Strike carries is worth less than it looks against
a target you cannot reach quickly.

## While the force is away, and when it comes back

A group attack does not leave the moment you file it. You set the wait in hours,
between 12 and 120, and it sits on the launch pad until then — other barons can
...
report that turns up after that is thrown away rather than paid out twice.
