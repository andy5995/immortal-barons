...
// PeopleFoodNeed and ArmyFoodNeed are the two food obligations BRE bills
// separately — and scores separately, since the people's shortfall costs
// popular support and the army's costs military morale. Only troopers eat.
func (e *Empire) PeopleFoodNeed() int { return e.People * PeopleFoodPerThousand / 1000 }
func (e *Empire) ArmyFoodNeed() int   { return e.Troopers / ArmyFoodDivisor }

// roundDiv divides to the nearest integer, matching the Turbo Pascal Round the
// original applies after scaling a stat by a fraction. n is never negative here.
...
func (w *World) feed(e *Empire) {
	peopleNeed, armyNeed := e.PeopleFoodNeed(), e.ArmyFoodNeed()
